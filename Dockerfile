...
COPY packages/library/package.json packages/library/tsconfig.json packages/library/
COPY packages/watches/package.json packages/watches/tsconfig.json packages/watches/
